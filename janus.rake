...
#vim_plugin_task "pyflakes",         "git://github.com/mitechie/pyflakes-pathogen.git" do
#    sh "echo `pwd`"
#    sh "git submodule init && git submodule update"
#end
# Something that isn't version sensitive would be better...
vim_plugin_task "pyflakes",         "http://www.vim.org/scripts/download_script.php?src_id=14403"
